    ...
    <div className="flex flex-col gap-3">
      ...
      {loading && vivaExams.length === 0 ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 text-center">
          <p className="text-zinc-500 dark:text-gray-400 text-sm">No viva exams found.</p>
          <p className="mt-1 text-zinc-400 dark:text-gray-500 text-xs">Click the plus icon to create a viva.</p>
        </div>
      )}

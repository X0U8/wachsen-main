          ...
          >
            ...
            >
              <div className="flex flex-col sm:flex-row sm:items-center gap-x-3 gap-y-1">
                <span
                  className="font-bold text-zinc-805 dark:text-gray-250 flex items-center gap-2 text-xs">
                  <span
                    className="px-2 py-0.5 bg-blue-500/10 text-blue-500 rounded-md font-extrabold text-xs">Month {m.month}</span>
                  chapters
                </span>
                <span
                  className="text-zinc-400 font-semibold bg-zinc-100 dark:bg-zinc-800 px-2 py-0.5 rounded-md self-start text-xs">

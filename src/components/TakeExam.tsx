        ...
        {showStartModal && (
          ...
          >
            <motion.div
              ...
              animate={{ scale: 1, y: 0 }}
              className="bg-zinc-100 dark:bg-gray-900 border border-zinc-200 dark:border-gray-800 rounded-3xl p-8 w-full max-w-md space-y-8 shadow-2xl text-center"
            >
              ...
              <div className="flex gap-4">
                <button
                  onClick={() => navigate(-1)}
                  className="flex-1 py-4 bg-zinc-200 dark:bg-gray-800 hover:bg-zinc-300 dark:hover:bg-gray-700 text-zinc-900 dark:text-white rounded-2xl transition-all"
                >
                  Cancel
                </button>
                <button
